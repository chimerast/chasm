...
//***************************************************************************
// クラス名  : TChimeraVector
// Version   : 0.8 (2001/06/26)
//***************************************************************************
inline TChimeraVector::TChimeraVector(void)
{
}
//---------------------------------------------------------------------------
inline TChimeraVector::TChimeraVector(long AX, long AY)
    : X(AX), Y(AY)
{
}
//---------------------------------------------------------------------------
inline TChimeraVector TChimeraVector::operator +(const TChimeraVector& rhs) const
{
    return TChimeraVector(X+rhs.X, Y+rhs.Y);
}
//---------------------------------------------------------------------------
inline TChimeraVector TChimeraVector::operator -(const TChimeraVector& rhs) const
{
...
//---------------------------------------------------------------------------
inline TChimeraVector& TChimeraVector::operator +=(const TChimeraVector &rhs)
{
...
// Version   : 0.8 (2001/06/26)
//***************************************************************************
inline TChimeraRect::TChimeraRect(void)
{
}
//---------------------------------------------------------------------------
inline TChimeraRect::TChimeraRect(long AX1, long AY1, long AX2, long AY2)
    : X1(AX1), Y1(AY1), X2(AX2), Y2(AY2)
{
}
//---------------------------------------------------------------------------
inline TChimeraRect TChimeraRect::operator +(const TChimeraRect& rhs) const
{
    return TChimeraRect(X1+rhs.X1, Y1+rhs.Y1, X2+rhs.X2, Y2+rhs.Y2);
}
//---------------------------------------------------------------------------
inline TChimeraRect TChimeraRect::operator -(const TChimeraRect& rhs) const
{
...
//---------------------------------------------------------------------------
inline TChimeraRect& TChimeraRect::operator +=(const TChimeraRect &rhs)
{
...
//---------------------------------------------------------------------------
inline TChimeraVector TChimeraRect::operator [](const int n) const
{
    return n == 0 ? TChimeraVector(X1, Y1) : TChimeraVector(X2, Y2);
}
//---------------------------------------------------------------------------
inline long TChimeraRect::Width(void) const
{
    return X2 - X1;
}
//---------------------------------------------------------------------------
inline long TChimeraRect::Height(void) const
{
    return Y2 - Y1;
}
//---------------------------------------------------------------------------
...
{
    if(ChimeraSystem::Has3DNow)
    {
        TChimera3DVector Ret;
        ChimeraSystem::VectorCrossProduct(&Ret, this, &rhs);
        return Ret;
    }
    else
    {
...
inline TChimera3DVector& TChimera3DVector::Normalize(void)
{
    ...
    {
        TChimera3DVector Ret;
        ChimeraSystem::VectorNormalize(&Ret, this);
        return *this = Ret;
    }
    else
    {
