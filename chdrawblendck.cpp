...
{
    void ColorKeyTransBlend16MMX(const TChimeraDrawDirect &Param);
    void ColorKeyAddBlend16MMX(const TChimeraDrawDirect &Param);
    void ColorKeyModBlend16MMX(const TChimeraDrawDirect &Param);
    void ColorKeySubBlend16MMX(const TChimeraDrawDirect &Param);

    void ColorKeyTransBlend32MMX(const TChimeraDrawDirect &Param);
    void ColorKeyAddBlend32MMX(const TChimeraDrawDirect &Param);
    void ColorKeyModBlend32MMX(const TChimeraDrawDirect &Param);
    void ColorKeySubBlend32MMX(const TChimeraDrawDirect &Param);
};
...
// 16bit ＯＮＬＹ！　速度重視
//***************************************************************************
void ChimeraDrawSystem::ColorKeyRotDraw16(const TChimeraDrawDirect &Param)
{
    ...
    unsigned short ColorKey = TChimeraDrawDirect::ColorKey;
...
// 24bit ＯＮＬＹ！　速度重視
//***************************************************************************
void ChimeraDrawSystem::ColorKeyRotDraw24(const TChimeraDrawDirect &Param)
{
    using TChimeraDrawDirect::DCos;
    using TChimeraDrawDirect::DSin;
    using TChimeraDrawDirect::ScreenWidth;
...
// 32bit ＯＮＬＹ！　速度重視
//***************************************************************************
void ChimeraDrawSystem::ColorKeyRotDraw32(const TChimeraDrawDirect &Param)
{
    using TChimeraDrawDirect::DCos;
    using TChimeraDrawDirect::DSin;
    using TChimeraDrawDirect::ScreenWidth;
...
// 16bit ＯＮＬＹ！　速度重視
//***************************************************************************
void ChimeraDrawSystem::ColorKeyRotDraw16MMX(const TChimeraDrawDirect &Param)
{
    using TChimeraDrawDirect::DCos;
    using TChimeraDrawDirect::DSin;
    using TChimeraDrawDirect::ScreenWidth;
...
// 加算
//***************************************************************************
void ChimeraDrawSystem::ColorKeyAddDraw(const TChimeraDrawDirect &Param)
{
...
// 乗算
//***************************************************************************
void ChimeraDrawSystem::ColorKeyModDraw(const TChimeraDrawDirect &Param)
{
    using TChimeraDrawDirect::RMask;
    using TChimeraDrawDirect::GMask;
    using TChimeraDrawDirect::BMask;
...
// 半透明合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyTransBlend(const TChimeraDrawDirect &Param)
{
    using TChimeraDrawDirect::RMask;
    using TChimeraDrawDirect::GMask;
    using TChimeraDrawDirect::BMask;
...
// 加算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyAddBlend(const TChimeraDrawDirect &Param)
{
    using TChimeraDrawDirect::RMask;
    using TChimeraDrawDirect::GMask;
    using TChimeraDrawDirect::BMask;
...
// 乗算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyModBlend(const TChimeraDrawDirect &Param)
{
    using TChimeraDrawDirect::RMask;
    using TChimeraDrawDirect::GMask;
    using TChimeraDrawDirect::BMask;
...
// 減算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeySubBlend(const TChimeraDrawDirect &Param)
{
    using TChimeraDrawDirect::RMask;
    using TChimeraDrawDirect::GMask;
    using TChimeraDrawDirect::BMask;
...
// 半透明合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyTransBlend16MMX(const TChimeraDrawDirect &Param)
{
...
// 加算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyAddBlend16MMX(const TChimeraDrawDirect &Param)
{
...
// 乗算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyModBlend16MMX(const TChimeraDrawDirect &Param)
{
    Blend16MMXInitialize;
...
// 減算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeySubBlend16MMX(const TChimeraDrawDirect &Param)
{
    Blend16MMXInitialize;
...
// 半透明合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyTransBlend16AlphaMMX(const TChimeraDrawDirect &Param)
{
    if(Param.Param1 == 0x80)
    { ColorKeyTransBlend16MMX(Param); return; }
...
// 加算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyAddBlend16AlphaMMX(const TChimeraDrawDirect &Param)
{
    if(Param.Param1 == 0xFF)
    { ColorKeyAddBlend16MMX(Param); return; }
...
// 乗算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyModBlend16AlphaMMX(const TChimeraDrawDirect &Param)
{
    if(Param.Param1 == 0xFF)
    { ColorKeyModBlend16MMX(Param); return; }
...
// 減算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeySubBlend16AlphaMMX(const TChimeraDrawDirect &Param)
{
    if(Param.Param1 == 0xFF)
    { ColorKeySubBlend16MMX(Param); return; }
...
// 半透明合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyTransBlend32MMX(const TChimeraDrawDirect &Param)
{
...
// 加算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyAddBlend32MMX(const TChimeraDrawDirect &Param)
{
    Blend32MMXInitialize;
...
// 乗算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyModBlend32MMX(const TChimeraDrawDirect &Param)
{
    Blend32MMXInitialize;
...
// 減算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeySubBlend32MMX(const TChimeraDrawDirect &Param)
{
    Blend32MMXInitialize;
...
// 半透明合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyTransBlend32AlphaMMX(const TChimeraDrawDirect &Param)
{
    if(Param.Param1 == 0x80)
    { ColorKeyTransBlend32MMX(Param); return; }
...
// 加算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyAddBlend32AlphaMMX(const TChimeraDrawDirect &Param)
{
    if(Param.Param1 == 0xFF)
    { ColorKeyAddBlend32MMX(Param); return; }
...
// 乗算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeyModBlend32AlphaMMX(const TChimeraDrawDirect &Param)
{
    if(Param.Param1 == 0xFF)
    { ColorKeyModBlend32MMX(Param); return; }
    unsigned __int64 XORMask64 = 0xFFFFFFFFFFFFFFFFui64;
...
// 減算合成
//***************************************************************************
void ChimeraDrawSystem::ColorKeySubBlend32AlphaMMX(const TChimeraDrawDirect &Param)
{
    if(Param.Param1 == 0xFF)
    { ColorKeySubBlend32MMX(Param); return; }
